...
<div class="field">
  ...
  <select id="report-pick" onchange="location.href='/app/reports?r='+this.value">
...
<a class="btn secondary small mb-3" href="/api/export?report=<?= e($report) ?>">⬇ Download as CSV</a>
  ...
  <table class="report">
    ...
    <?php foreach ($rows as $r): ?>
      <tr>
        ...
        <td><a class="btn small" href="/app/sale?id=<?= (int)$r['sale_id'] ?>">Record Payment</a></td>
      </tr>
    <?php endforeach; ?>
    </tbody>
  </table>
