...
<div class="list mb-3">
  <a class="btn" href="/app/sale-new"><?= icon('sale', 20) ?> Record a Sale</a>
  <a class="btn secondary" href="/app/batches">Record Seedlings Lost / Activity</a>
</div>
<?php endif; ?>
...
<?php foreach ($openPreorders as $p): ?>
  <a class="list-item" href="/app/preorders">
    <div>
