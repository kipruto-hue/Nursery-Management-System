...
<a class="list-item mb-3" href="/app/debtors.php" style="border-left:4px solid var(--color-danger)">
  <div>
...
<?php foreach ($sales as $s): ?>
  <a class="list-item" href="/app/sale.php?id=<?= (int)$s['id'] ?>">
    <div>
...
<a href="/app/sale-new.php" class="fab" aria-label="New sale">＋</a>
