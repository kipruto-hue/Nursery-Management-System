...
<?php foreach ($preorders as $p): ?>
  <div class="list-item">
    ...
    <div class="right">
      ...
      <div class="mt-2"><a class="btn small" href="/app/sale-new.php?preorder=<?= (int)$p['id'] ?>">Fulfil</a></div>
      <?php if (is_owner()): ?>
      ...
      <div class="small mt-2"><a href="/app/sale.php?id=<?= (int)$p['fulfilled_sale_id'] ?>">View sale</a></div>
      <?php endif; ?>
    </div>
  </div>
<?php endforeach; ?>
