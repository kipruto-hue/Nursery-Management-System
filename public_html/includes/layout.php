...
function page_bottom(string $page = '', array $scripts = []): void {
    $tabs = [
        ['dashboard', '/app/dashboard.php', 'Home',    'home'],
        ['batches',   '/app/batches.php',   'Batches', 'sprout'],
        ['sales',     '/app/sales.php',     'Sales',   'sale'],
    ];
    if (is_owner()) {
        $tabs[] = ['reports', '/app/reports.php', 'Reports', 'report'];
    }
    $tabs[] = ['more', '/app/more.php', 'More', 'more'];
    ?>
</main>
